...
raw GitHub-ready package \cite{cortiA224540Package2026}.  For a fixed
...
summaries, and independent artifact-level validator are part of the raw
GitHub-ready package and are intended for inclusion in the project repository
and archive listed in the References when those public artifacts are finalized.
...
The GitHub URL and Zenodo DOI in the reference below are publication metadata
for the final public release.  They are intentionally provisional in this
pre-release manuscript and must be updated only after the repository and
Zenodo archive are officially published.  Until that publication step occurs,
their provisional status is a final-release packaging item, not a mathematical
or computational defect in the draft.
...
raw GitHub-ready package and planned Zenodo archive, 2026.
\url{https://github.com/carcorti/A224540}.
Zenodo DOI placeholder: \texttt{10.5281/zenodo.xxxxxxxx}, to be replaced
after archive publication.
